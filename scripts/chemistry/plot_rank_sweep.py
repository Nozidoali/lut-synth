...
sys.path.insert(0, str(PROJECT_ROOT / "scripts" / "chemistry" / "src"))
from decode import decode_per_register, read_tt_file  # noqa: E402
...
def run_experiments() -> None:
    ...
    """
    run_sweep_script = PROJECT_ROOT / "scripts" / "chemistry" / "run_sweep.py"
